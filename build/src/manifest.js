...
class Manifest {
    ...
    async throwIfChangesBranchesRaceConditionDetected(pullRequests) {
        for (const pr of pullRequests) {
            const branchName = branch_name_1.BranchName.parse(pr.headBranchName);
            ...
            throw new Error('Race condition detected. The ref branch used to create the release pull request branch received new commits. Cannot safely reset branch.');
        }
    }

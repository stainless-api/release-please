...
function stubFilesFromFixtures(options) {
    ...
    const targetBranch = (_b = options.targetBranch) !== null && _b !== void 0 ? _b : 'main';
...
function buildMockCandidatePullRequest(path, releaseType, versionString, options = {}) {
    ...
    return {
        ...
        pullRequest: {
            ...
            headRefName: branch_name_1.BranchName.ofTargetBranch('main', 'main').toString(),
            version,
...
class MockPullRequestOverflowHandler {
    async handleOverflow(pullRequest, _baseBranch, _maxSize) {

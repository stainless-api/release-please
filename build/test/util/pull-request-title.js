...
(0, mocha_1.describe)('PullRequestTitle', () => {
    (0, mocha_1.describe)('parse', () => {
        ...
        (0, mocha_1.it)('parses a target branch and changes branch', () => {
            var _a;
    ...
    (0, mocha_1.describe)('ofTargetBranch', () => {
        (0, mocha_1.it)('builds branchname with only target branch', () => {
            const pullRequestTitle = pull_request_title_1.PullRequestTitle.ofTargetBranch('main', 'main');
            (0, chai_1.expect)(pullRequestTitle.toString()).to.eql('chore(main): release');
        });
        (0, mocha_1.it)('builds branchname with target branch and changes branch', () => {
            const pullRequestTitle = pull_request_title_1.PullRequestTitle.ofTargetBranch('main', 'next');
            (0, chai_1.expect)(pullRequestTitle.toString()).to.eql('chore(next => main): release');
        });
    });
    (0, mocha_1.describe)('ofTargetBranchVersion', () => {
        (0, mocha_1.it)('builds branchname with target branch and version', () => {
            const pullRequestTitle = pull_request_title_1.PullRequestTitle.ofTargetBranchVersion('main', 'main', version_1.Version.parse('1.2.3'));
    ...
    (0, mocha_1.describe)('ofComponentTargetBranch', () => {
        (0, mocha_1.it)('builds branchname with target branch and component', () => {
            const pullRequestTitle = pull_request_title_1.PullRequestTitle.ofComponentTargetBranchVersion('foo', 'main', 'main', version_1.Version.parse('1.2.3'));
    ...
    (0, mocha_1.describe)('generateMatchPattern', () => {
        (0, mocha_1.it)('return matchPattern with default Pattern', () => {
            ...
            (0, chai_1.expect)(matchPattern).to.eql(/^chore(\((?<changesBranch>[\w-./]+ => )?(?<branch>[\w-./]+)\))?: release ?(?<component>@?[\w-./]*)? v?(?<version>[0-9].*)$/);
        });
    });
});
(0, mocha_1.describe)('PullRequestTitle with custom pullRequestTitlePattern', () => {
    ...
    (0, mocha_1.describe)('ofTargetBranch', () => {
        (0, mocha_1.it)('builds branchname with only target branch', () => {
            const pullRequestTitle = pull_request_title_1.PullRequestTitle.ofTargetBranchVersion('main', 'main', version_1.Version.parse('1.2.3'), 'chore${scope}: 🔖 release${component} ${version}');
            (0, chai_1.expect)(pullRequestTitle.toString()).to.eql('chore(main): 🔖 release 1.2.3');
        });
        (0, mocha_1.it)('builds branchname with target branch and changes branch', () => {
            const pullRequestTitle = pull_request_title_1.PullRequestTitle.ofTargetBranchVersion('main', 'next', version_1.Version.parse('1.2.3'), 'chore${scope}: 🔖 release${component} ${version}');
            (0, chai_1.expect)(pullRequestTitle.toString()).to.eql('chore(next => main): 🔖 release 1.2.3');
        });
    });
    (0, mocha_1.describe)('ofComponentTargetBranch', () => {
        (0, mocha_1.it)('builds branchname with target branch and component', () => {
            const pullRequestTitle = pull_request_title_1.PullRequestTitle.ofComponentTargetBranchVersion('foo', 'main', 'main', version_1.Version.parse('1.2.3'), 'chore${scope}: 🔖 release${component} ${version}');
            (0, chai_1.expect)(pullRequestTitle.toString()).to.eql('chore(main): 🔖 release foo 1.2.3');
        });
        (0, mocha_1.it)('builds branchname with target branch, changes branch, and component', () => {
            const pullRequestTitle = pull_request_title_1.PullRequestTitle.ofComponentTargetBranchVersion('foo', 'main', 'next', version_1.Version.parse('1.2.3'), 'chore${scope}: 🔖 release${component} ${version}');
            (0, chai_1.expect)(pullRequestTitle.toString()).to.eql('chore(next => main): 🔖 release foo 1.2.3');
        });
    });
    (0, mocha_1.describe)('generateMatchPattern', () => {

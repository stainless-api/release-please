...
(0, mocha_1.describe)('BranchName', () => {
    (0, mocha_1.describe)('parse', () => {
        (0, mocha_1.describe)('autorelease branch name', () => {
            (0, mocha_1.it)('parses a versioned branch name', () => {
                ...
                (0, chai_1.expect)(branchName === null || branchName === void 0 ? void 0 : branchName.getChangesBranch()).to.be.undefined;
        ...
        (0, mocha_1.it)('parses a target branch with changes branch', () => {
            const name = 'release-please--branches--main--changes--next';
            const branchName = branch_name_1.BranchName.parse(name);
            (0, chai_1.expect)(branchName).to.not.be.undefined;
            (0, chai_1.expect)(branchName === null || branchName === void 0 ? void 0 : branchName.getTargetBranch()).to.eql('main');
            (0, chai_1.expect)(branchName === null || branchName === void 0 ? void 0 : branchName.getChangesBranch()).to.eql('next');
            (0, chai_1.expect)(branchName === null || branchName === void 0 ? void 0 : branchName.getComponent()).to.be.undefined;
            (0, chai_1.expect)(branchName === null || branchName === void 0 ? void 0 : branchName.getVersion()).to.be.undefined;
            (0, chai_1.expect)(branchName === null || branchName === void 0 ? void 0 : branchName.toString()).to.eql(name);
        });
        ...
        (0, mocha_1.it)('parses a target branch, changes branch, and component', () => {
            const name = 'release-please--branches--main--changes--next--components--storage';
            const branchName = branch_name_1.BranchName.parse(name);
            (0, chai_1.expect)(branchName).to.not.be.undefined;
            (0, chai_1.expect)(branchName === null || branchName === void 0 ? void 0 : branchName.getTargetBranch()).to.eql('main');
            (0, chai_1.expect)(branchName === null || branchName === void 0 ? void 0 : branchName.getChangesBranch()).to.eql('next');
    ...
    (0, mocha_1.describe)('ofTargetBranch', () => {
        (0, mocha_1.it)('builds branchname with only target branch', () => {
            const branchName = branch_name_1.BranchName.ofTargetBranch('main', 'main');
        ...
        (0, mocha_1.it)('builds branchname with target branch and changes branch', () => {
            const branchName = branch_name_1.BranchName.ofTargetBranch('main', 'next');
            (0, chai_1.expect)(branchName.toString()).to.eql('release-please--branches--main--changes--next');
        });
    });
    (0, mocha_1.describe)('ofComponentTargetBranch', () => {
        (0, mocha_1.it)('builds branchname with target branch and component', () => {
            const branchName = branch_name_1.BranchName.ofComponentTargetBranch('foo', 'main', 'main');
        ...
        (0, mocha_1.it)('builds branchname with target branch, changes branch, and component', () => {
            const branchName = branch_name_1.BranchName.ofComponentTargetBranch('foo', 'main', 'next');
            (0, chai_1.expect)(branchName.toString()).to.eql('release-please--branches--main--changes--next--components--foo');
        });
    });
});

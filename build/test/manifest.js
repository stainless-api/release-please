...
(0, mocha_1.describe)('Manifest', () => {
    ...
    (0, mocha_1.describe)('buildReleases', () => {
        ...
        (0, mocha_1.it)('should build prerelease releases when forcePrerelease is true', async () => {
            mockPullRequests(github, [], [
                {
                    headBranchName: 'release-please/branches/main',
                    baseBranchName: 'main',
        ...
        (0, mocha_1.it)('should build prerelease releases from non-prerelease when forcePrerelease is true', async () => {
            mockPullRequests(github, [], [
                {
                    headBranchName: 'release-please/branches/main',
                    baseBranchName: 'main',
